var character = [
    ...
    { value: "4", name: "Albert Einstein", faculty: 'School of Business', facultyValue:'busi', rating: 4.9, reviews: "Perfect, best instructor in the school", picture: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d3/Albert_Einstein_Head.jpg/1536px-Albert_Einstein_Head.jpg" }
]
...
function facultyFilter(value) {
    ...
    const filteredCharacters = character.filter(character => {
        const matchesFaculty = facultyValue == "all" || character.facultyValue == facultyValue;
...
const displayCharacters = (characters) => {
    const htmlString = characters.map((character) => {
        return `
            <li class="character">  
                <a href="profile${character.value}.html">
